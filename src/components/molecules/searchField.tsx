...
const InputSearch = ({ refForm, register, setValue, placeholder, setFocus }: Props): ReactElement => {
    ...
    return (
        ...
        >
            <div className=" bg-neo_blue-light h-8 flex items-center rounded-full overflow-hidden">
