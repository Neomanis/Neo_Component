...
const Template3: ComponentStory<typeof ScrollSlider> = () => {
    const scrollElementRef = useRef<HTMLDivElement>(null);
    ...
    return (
        <div>
            <div className="w-72">
                <ScrollSlider onChange={(value) => handleScroll(value)} arrowsValue={20} />
            </div>
            <div ref={scrollElementRef} className="w-[600px] overflow-auto mt-5 no-scrollbar">
                <p className="text-white whitespace-nowrap">
                    Try to move the slider above me ! Im a very long text that need to be scrolled, but you can't do it
...
export const WithBigSteps: ComponentStory<typeof ScrollSlider> = Template3.bind({});
