...
import TitleNeomanisStorybook from "./titleNeomanisStorybook.png";
...
export { DefaultUserPicture, TitleNeomanisStorybook, LogoBleuCarre, LogoBlanc, LogoBleu, LogoFullBlanc };
